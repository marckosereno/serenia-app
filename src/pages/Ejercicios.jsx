...
function PantallaPrep({ tecnica, onIniciar, onCancelar }) {
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          boxShadow: `0 0 40px ${tecnica.color}44`,
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      {/* Header con botón atrás estilo img1 */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 4 }}>
        ...
        <div>
          ...
          <p style={{ fontFamily: 'DM Serif Display, serif', fontSize: 20, margin: 0 }}>
            {tecnica.nombre}
          </p>
        </div>
      </div>
      ...
      <div style={{ background: tecnica.bg, borderRadius: 20, padding: 20 }}>
        ...
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 14 }}>
          {tecnica.fases.map((f, i) => (
            <span key={i} style={{
              background: `${tecnica.color}22`, color: tecnica.color,
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        {[
          ...
          <div key={i} style={{
            ...
            <p style={{ fontSize: 13, color: '#6b7280', margin: 0, fontFamily: 'DM Sans, sans-serif' }}>{tip.texto}</p>
          </div>
        ))}
      </div>

      {/* Botón comenzar */}
      <button onClick={iniciarConteo} style={{
        background: tecnica.color, color: 'white',
  ...
  if (terminado) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '32px 0', gap: 20 }}>
        ...
        <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 26, fontWeight: 400, color: '#1a1a1a', margin: 0 }}>
          ¡Completado!
        </h2>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20, padding: '8px 0' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
        ...
        <button onClick={toggleSonido} style={{
          ...
          background: sonidoOn ? tecnica.color : 'white',
          border: 'none', boxShadow: '0 2px 8px rgba(0,0,0,0.1)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          cursor: 'pointer', padding: '0 16px', gap: 6,
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 28, fontWeight: 400, color: '#1a1a1a', margin: '4px 0' }}>
          {fase.label}
        </h2>
        <p style={{ fontSize: 48, fontWeight: 700, color: tecnica.color, fontFamily: 'DM Sans, sans-serif', margin: 0, lineHeight: 1 }}>
          ...
          <div key={t.id} className="card" style={{ background: t.bg }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: 13, color: '#555', marginTop: 3, lineHeight: 1.5, marginBottom: 8 }}>
                  {t.descripcion}
                </p>
          ...
          <div key={i} className="card" style={{ background: p.bg }}>
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 13, color: '#374151', marginTop: 4, lineHeight: 1.6, marginBottom: 0 }}>
                  {p.desc}
                </p>
              </div>
            </div>
