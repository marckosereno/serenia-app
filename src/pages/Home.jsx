  ...
  return (
    <div>
      <div className="page-header">
        <p style={{ color: '#3d7a5e', fontWeight: 600, fontSize: 13, letterSpacing: 1, textTransform: 'uppercase' }}>
          {saludo}
        </p>
      ...
      <div style={{ padding: '0 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {/* Card principal */}
        <div className="card" style={{ background: 'linear-gradient(135deg, #3d7a5e, #5a9e7a)', color: 'white' }}>
          <p style={{ fontSize: 13, opacity: 0.85 }}>Tu espacio seguro</p>
          <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 22, fontWeight: 400, marginTop: 4 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          {accesos.map(a => (
            ...
            >
              ...
              <p style={{ marginTop: 8, fontWeight: 600, fontSize: 13, fontFamily: 'DM Sans, sans-serif' }}>
                {a.label}
              </p>
            </button>
          ))}
